...
namespace Absencespot.SqlServer.Migrations
{
    ...
    [Migration("20240204172335_added_subscription_companyId")]
    partial class added_subscription_companyId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Absencespot.Domain.AvailableLeave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AvailableLeave", (string)null);
                });
            ...
            modelBuilder.Entity("Absencespot.Domain.AvailableLeave", b =>
                {
                    b.HasOne("Absencespot.Domain.Absence", "Absence")
            ...
            modelBuilder.Entity("Absencespot.Domain.Request", b =>
                {
                    b.HasOne("Absencespot.Domain.User", "Approver")
                        .WithMany("Approved")
                    ...
                    b.HasOne("Absencespot.Domain.User", "OnBehalfOf")
                        .WithMany("OnBehalfOfs")
            ...
            modelBuilder.Entity("Absencespot.Domain.Subscription", b =>
                {
                    b.HasOne("Absencespot.Domain.Company", "Company")
                        .WithOne("Subcription")
                        .HasForeignKey("Absencespot.Domain.Subscription", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
