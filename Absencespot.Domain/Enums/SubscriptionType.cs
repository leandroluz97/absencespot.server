...
namespace Absencespot.Domain.Enums
{
    public class SubscriptionType : Enumeration
    {
        ...
        public static readonly SubscriptionType BUSINESS = new SubscriptionType(1, "BUSINESS");
        public static readonly SubscriptionType ENTERPRISE = new SubscriptionType(1, "ENTERPRISE");
