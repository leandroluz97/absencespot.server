...
namespace Absencespot.Infrastructure.Abstractions.Clients.Calendar
{
    public interface ICalendarClient
    {
        ...
        Task<Google.Apis.Calendar.v3.Data.Calendar> GetByOwnerId(string calendarId, CancellationToken cancellationToken = default);
        Task<CalendarList> GetListAsync(CancellationToken cancellationToken = default);
        Task<Events> GetEventListAsync(string calendarId, CancellationToken cancellationToken = default);
        ...
        Task<Events?> GetHolidays(string country, CancellationToken cancellationToken = default);
    }
}
